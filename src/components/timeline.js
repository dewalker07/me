                  ...
                  <article className="timeline-entry animate-box" data-animate-effect="fadeInTop">
                    <div className="timeline-entry-inner">
                      ...
                      <div className="timeline-label">
                        ...
                        <p>I am pursued my degree in ME(Mechanical Engineering), But later on I moved in IT industry, I learned new technologies which are trending in industry finally I had succeeded in this field to get my job from that time it goes on....</p>
                      </div>
                    </div>
                  </article>
                  {/* <article className="timeline-entry animate-box" data-animate-effect="fadeInLeft">
